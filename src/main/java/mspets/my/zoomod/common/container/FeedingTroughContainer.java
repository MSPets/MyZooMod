package mspets.my.zoomod.common.container;

import mspets.my.zoomod.common.registry.BlockRegistries;
import mspets.my.zoomod.common.registry.ContainerRegistries;
...
public class FeedingTroughContainer extends Container {
    ...
    public FeedingTroughContainer(int windowId, World world, BlockPos pos,
                                  PlayerInventory playerInventory, PlayerEntity player) {
        super(ContainerRegistries.FEEDING_TROUGH_CONTAINER.get(), windowId);
    ...
    public boolean canInteractWith(PlayerEntity playerIn) {
        return isWithinUsableDistance(IWorldPosCallable.of(tileEntity.getWorld(), tileEntity.getPos()),
                playerIn, BlockRegistries.FEEDING_TROUGH.get());
    }
